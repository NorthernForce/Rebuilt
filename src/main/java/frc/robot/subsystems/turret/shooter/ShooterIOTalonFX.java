...
public class ShooterIOTalonFX implements ShooterIO
{
    ...
    {
        this(constants.motor1ID(), constants.motor2ID(), constants.kS(), constants.kV(), constants.kA(), constants.kP(),
                constants.kI(), constants.kD(), constants.kG(), constants.cruiseVelocity(), constants.acceleration(),
                constants.jerk(), constants.motor1Inverted(), constants.motor2Inverted(), constants.errorTolerance());
    }

    public ShooterIOTalonFX(int motor1ID, int motor2ID, double kS, double kV, double kA, double kP, double kI,
            double kD, double kG, double cruiseVelocity, double acceleration, double jerk, boolean motor1Inverted,
            boolean motor2Inverted, AngularVelocity errorTolerance)
    {
        ...
        m_motor1.getConfigurator().apply(new MotorOutputConfigs().withInverted(
                motor1Inverted ? InvertedValue.CounterClockwise_Positive : InvertedValue.Clockwise_Positive));
        m_motor2.getConfigurator().apply(new MotorOutputConfigs().withInverted(
                motor2Inverted ? InvertedValue.CounterClockwise_Positive : InvertedValue.Clockwise_Positive));
