...
public record ClimberParameters(int motorID, int bottomLimitSwitchId, ClimbLevels bottomLevel, ClimbLevels l1Height,
        ...
        double kI, double kD, double kV, double kG, double topRotations, Pose2d upperBluePrepPose,
        Pose2d lowerBluePrepPose, Pose2d upperRedPrepPose, Pose2d lowerRedPrepPose, int servoID) {
