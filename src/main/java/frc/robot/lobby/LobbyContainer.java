...
public class LobbyContainer implements NFRRobotContainer {
        ...
        private final PowerDistribution powerDistributionHub = new PowerDistribution(
                        LobbyConstants.PDHConstants.kPDHPort,
        ...
        public LobbyContainer() {
                ...
                drive = new CommandSwerveDrivetrain(LobbyTunerConstants.DrivetrainConstants,
                                LobbyConstants.DrivetrainConstants.kMaxSpeed,
                                LobbyConstants.DrivetrainConstants.kMaxAngularSpeed,
                                LobbyTunerConstants.FrontLeft, LobbyTunerConstants.FrontRight,
                                LobbyTunerConstants.BackLeft,
                ...
                if (Utils.isSimulation()) {
                        climber = new Climber(
                                        new ClimberIOTalonFXSim(LobbyConstants.ClimberConstants.kClimberParameters),
                        ...
                        turret = new Turret(new TurretConstants(LobbyConstants.Turret.offset),
                                        ...
                                        new Shooter(new ShooterIOTalonFXSim(
                                                        LobbyConstants.Turret.Shooter.kKrakenSimConstants)),
                                        new TrigHoodTargetingCalculator(), new TrigHoodTargetingCalculator(),
                                        new TrigHoodTargetingCalculator());
                        spindexer = new Spindexer(
                                        new CarouselIOTalonFXSim(new CarouselConstants(
                                                        LobbyConstants.CarouselConstants.kMotorID,
                                                        LobbyConstants.CarouselConstants.kSpeed,
                                                        LobbyConstants.CarouselConstants.kGearRatio,
                                        ...
                                        new FlickerIOTalonFXSSim(new FlickerSimParameters(
                                                        LobbyConstants.FlickerConstants.kMotorId,
                                                        LobbyConstants.FlickerConstants.kRampSpeed,
                                                        LobbyConstants.FlickerConstants.kGearRatio,
                                                        LobbyConstants.FlickerConstants.kV,
                                                        LobbyConstants.FlickerConstants.kP,
                                                        LobbyConstants.FlickerConstants.kI,
                                                        LobbyConstants.FlickerConstants.kD,
                                                        LobbyConstants.FlickerConstants.kErrorTolerance,
                                                        LobbyConstants.FlickerConstants.kSimRpm,
                                                        LobbyConstants.FlickerConstants.kSimMoi,
                                                        LobbyConstants.FlickerConstants.kJamCurrentThreshold,
                                                        LobbyConstants.FlickerConstants.kJamTimeout,
                                                        LobbyConstants.FlickerConstants.kDejamSpeed)),
                        ...
                        vision = new AprilTagVision(drive,
                                        ...
                                        new AprilTagVisionIOLimelight(
                                                        ...
                                                        LobbyConstants.VisionConstants.LimeLightConstants.kValidIds),
                                        new AprilTagVisionIOLimelight(
                                                        LobbyConstants.VisionConstants.LimeLightConstants.kBackLimeLightName,
                        ...
                        turret = new Turret(new TurretConstants(LobbyConstants.Turret.offset),
                                        ...
                                        new Shooter(new ShooterIOTalonFX(
                                                        LobbyConstants.Turret.Shooter.kKrakenConstants)),
                        ...
                        spindexer = new Spindexer(
                                        new CarouselIOTalonFX(new CarouselConstants(
                                                        LobbyConstants.CarouselConstants.kMotorID,
                                                        LobbyConstants.CarouselConstants.kSpeed,
                                                        LobbyConstants.CarouselConstants.kGearRatio,
                                                        LobbyConstants.CarouselConstants.kInverted,
                                                        ...
                                                        LobbyConstants.CarouselConstants.kJamTimeout,
                                                        LobbyConstants.CarouselConstants.kDejamSpeed)),
                                        new FlickerIOTalonFXS(new FlickerParameters(
                                                        LobbyConstants.FlickerConstants.kMotorId,
                                                        LobbyConstants.FlickerConstants.kRampSpeed,
                                                        LobbyConstants.FlickerConstants.kGearRatio,
                                                        LobbyConstants.FlickerConstants.kV,
                ...
                NamedCommands.registerCommand("Shoot",
                                Commands.waitUntil(() -> turret.getSuzie().isAtTargetAngle()
                                                && turret.getShooter().isAtTargetSpeed())
                                                .andThen(new RunSpindexer(getSpindexer(),
                ...
                NamedCommands.registerCommand("StopIntake",
                                intake.stopIntake().andThen(intake.getRunToIntakeAngleCommand()));
                ...
                Shuffleboard.getTab("SysId").add("Turntable Dynamic Forward",
                                turret.getSuzie().getSysIdDynamicForward());
                Shuffleboard.getTab("SysId").add("Turntable Dynamic Reverse",
                                turret.getSuzie().getSysIdDynamicReverse());
                ...
                Shuffleboard.getTab("SysId").add("Shooter Dynamic Forward",
                                turret.getShooter().getSysIdDynamicForward());
                Shuffleboard.getTab("SysId").add("Shooter Dynamic Reverse",
                                turret.getShooter().getSysIdDynamicReverse());
                ...
                dashboard.putSystem("Developer", "Drivetrain")
                                .withCommand("SysId Move Quasistatic Forward",
                                                (drive.sysIdQuasistaticTranslation(Direction.kForward)))
                                .withCommand("SysId Move Quasistatic Reverse",
                                                (drive.sysIdQuasistaticTranslation(Direction.kReverse)))
                                .withCommand("SysId Move Dynamic Forward",
                                                (drive.sysIdDynamicTranslation(Direction.kForward)))
                                .withCommand("SysId Move Dynamic Reverse",
                                                (drive.sysIdDynamicTranslation(Direction.kReverse)))
                                .withCommand("SysId Steer Quasistatic Forward",
                                                (drive.sysIdQuasistaticSteer(Direction.kForward)))
                                .withCommand("SysId Steer Quasistatic Reverse",
                                                (drive.sysIdQuasistaticSteer(Direction.kReverse)))
                                .withCommand("SysId Steer Dynamic Forward",
                                                (drive.sysIdDynamicSteer(Direction.kForward)))
                                .withCommand("SysId Steer Dynamic Reverse",
                                                (drive.sysIdDynamicSteer(Direction.kReverse)))
                                .withCommand("SysId Rotation Quasistatic Forward",
                                                (drive.sysIdQuasistaticRotation(Direction.kForward)))
                                .withCommand("SysId Rotation Quasistatic Reverse",
                                                (drive.sysIdQuasistaticRotation(Direction.kReverse)))
                                .withCommand("SysId Rotation Dynamic Forward",
                                                (drive.sysIdDynamicRotation(Direction.kForward)))
                                .withCommand("SysId Rotation Dynamic Reverse",
                                                (drive.sysIdDynamicRotation(Direction.kReverse)));
                DashboardSystem turntableSystemDeveloper = dashboard.putSystem("Driver", "Turntable");
                turntableSystemDeveloper
                                .withCommand("Turntable SysId Quasistatic Forward",
                                                turret.getSuzie().getSysIdQuasistaticForward())
                                .withCommand("Turntable SysId Quasistatic Reverse",
                                                turret.getSuzie().getSysIdQuasistaticReverse())
                                .withCommand("Turntable SysId Dynamic Forward",
                                                turret.getSuzie().getSysIdDynamicForward())
                                .withCommand("Turntable SysId Dynamic Reverse",
                                                turret.getSuzie().getSysIdDynamicReverse());
        ...
        public Command driveToPreClimbPosition() {
                return Commands.defer(() -> {
                        ...
                        return AutoBuilder.pathfindToPose(target, new PathConstraints(MetersPerSecond.of(3),
                                        MetersPerSecondPerSecond.of(4), DegreesPerSecond.of(600),
        ...
        public Command driveToClimbPost() {
                return Commands.defer(() -> {
                        ...
                        return AutoBuilder.pathfindToPose(target, new PathConstraints(MetersPerSecond.of(0.25),
                                        MetersPerSecondPerSecond.of(0.5), DegreesPerSecond.of(600),
                                        DegreesPerSecondPerSecond.of(720)));
                }, java.util.Set.of(drive));
        }
        ...
        public void periodic() {
                ...
                DogLog.log("Turret/Position",
                                new Pose2d(getTurret().calculateFieldRelativeShooterPosition(drive.getPose()),
                                                new Rotation2d(turret.getSuzieAngleRobotRelative()
                                                                .plus(drive.getPose().getRotation().getMeasure()))));
                DogLog.log("Turret/Target Position",
                                new Pose2d(getTurret().calculateFieldRelativeShooterPosition(drive.getPose()),
                                                new Rotation2d(
                                                                turret.getSuzieTargetAngleRobotRelative()
                ...
                DogLog.log("Turret/Target Direction",
                                getTurret().calculateFieldRelativeShooterPosition(drive.getPose())
                                                .plus(new Translation2d(
                                                                Math.cos(getTurret().getSuzie().getTargetAngle()
                                                                                .in(Radians)
                                                                                + getDrive().getPose().getRotation()
                                                                                                .getRadians()),
                                                                Math.sin(getTurret().getSuzie().getTargetAngle()
                                                                                .in(Radians)
                                                                                + getDrive().getPose().getRotation()
                                                                                                .getRadians()))));
                DogLog.log("Turret/Direction",
                                getTurret().calculateFieldRelativeShooterPosition(drive.getPose())
                                                .plus(new Translation2d(
                                                                Math.cos(getTurret().getSuzieAngleRobotRelative()
                                                                                .in(Radians)
                                                                                + getDrive().getPose().getRotation()
                                                                                                .getRadians()),
                                                                Math.sin(getTurret().getSuzieAngleRobotRelative()
                                                                                .in(Radians)
                                                                                + getDrive().getPose().getRotation()
                                                                                                .getRadians()))));
                ...
                if (DriverStation.getGameSpecificMessage().indexOf('R') == 0) {
                        teamActivity = Optional
                                        .of((DriverStation.getAlliance()
                                                        .orElse(Alliance.Blue) == DriverStation.Alliance.Red) ? "active"
                                                                        : "inactive");
                } else if (DriverStation.getGameSpecificMessage().equals("B")) {
                        teamActivity = Optional
                                        .of((DriverStation.getAlliance()
                                                        .orElse(Alliance.Blue) == DriverStation.Alliance.Blue)
                                                                        ? "active"
                                                                        : "inactive");
                }
                ...
                if (!teamActivity.orElse("unknown").equals("unknown"))
                        ...
                        if (DriverStation.getMatchTime() > 130) {
                                ...
                                DogLog.log("GameData/GameShift",
                                                teamActivity.get().equals("inactive") ? "inactive" : "active");
        ...
        public Translation2d predictTurretPose() {
                return turret.calculateFieldRelativeShooterPosition(drive.getPose()).plus(turret.updateFromTOF(
                                drive.getPose(),
                                new Translation2d(drive.getXVelocity().in(MetersPerSecond),
                                                ...
                                                .plus(new Translation2d(
                                                                LobbyConstants.Turret.offsetDistance.in(Meters)
                                                                                * Math.sin(drive.getPose().getRotation()
                                                                                                .getRadians()
                                                                                                + LobbyConstants.Turret.offsetAngle
                                                                                                                .in(Radians))
                                                                                * drive.getThetaVelocity()
                                                                                                .in(RadiansPerSecond),
                                                                LobbyConstants.Turret.offsetDistance.in(Meters)
                                                                                * -Math.cos(drive.getPose()
                                                                                                .getRotation()
                                                                                                .getRadians()
                                                                                                + LobbyConstants.Turret.offsetAngle
                                                                                                                .in(Radians))
                                                                                * drive.getThetaVelocity().in(
                                                                                                RadiansPerSecond)))));
        }
        ...
        public Command closeDriveToPose(Pose2d pose) {
                CloseDriveToPoseRequest request = new CloseDriveToPoseRequest(pose,
                                LobbyConstants.DrivetrainConstants.kCloseDriveTP,
                                LobbyConstants.DrivetrainConstants.kCloseDriveTI,
                                LobbyConstants.DrivetrainConstants.kCloseDriveTD,
                                LobbyConstants.DrivetrainConstants.kCloseDriveRP,
                                LobbyConstants.DrivetrainConstants.kCloseDriveRI,
                                LobbyConstants.DrivetrainConstants.kCloseDriveRD,
                ...
                return Commands.runOnce(() -> request.reset(drive.getPose()))
                                ...
                                .andThen(drive.applyRequest(() -> new SwerveRequest.ApplyRobotSpeeds()
