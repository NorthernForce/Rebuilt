...
public class LobbyContainer implements NFRRobotContainer
{
    ...
    public LobbyContainer()
    {
        ...
        NamedCommands.registerCommand("StopIntakeAndStow",
                intake.stopIntake().andThen(intake.getRunToStowAngleCommand().repeatedly()));
        ...
        dashboard.putCommand("Developer", "Reset Intake Encoder", Commands.runOnce(() -> intake.resetEncoder()));
        dashboard.putBooleanTunable("Developer", "Reset Intake Encoder", (bool) ->
        {
            intake.setHingeBrakeMode(bool);
        });
    ...
    public Command driveToPreClimbPosition()
    {
        return Commands.defer(() ->
        {
            ...
            return AutoBuilder.pathfindToPose(target, new PathConstraints(MetersPerSecond.of(3),
                    MetersPerSecondPerSecond.of(4), DegreesPerSecond.of(600), DegreesPerSecondPerSecond.of(720)));
    ...
    public Command driveToClimbPost()
    {
        return Commands.defer(() ->
        {
            ...
            return AutoBuilder.pathfindToPose(target, new PathConstraints(MetersPerSecond.of(0.25),
                    MetersPerSecondPerSecond.of(0.5), DegreesPerSecond.of(600), DegreesPerSecondPerSecond.of(720)));
        }, java.util.Set.of(drive));
    }
